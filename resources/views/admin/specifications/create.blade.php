...
@section('title', 'Add Specification Type - ' . $category->name)

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2>Add Specification Type for {{ $category->name }}</h2>
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">New Specification Type</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.specifications.store', $category->id) }}" method="POST">
            @csrf
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-1"></i>Save Specification Type
                </button>
